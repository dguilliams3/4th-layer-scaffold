...
For non-trivial plans, consider where adversarial review checkpoints belong:
- After major phases that change architecture, data flow, or public APIs
- Always before archival (this is the default — propose it to the user)
- Ask the user: "Want me to add adversarial review checkpoints after steps X and Y?"
- See `docs/coding_agents/ADVERSARIAL_REVIEW.md` for the full protocol
- Skip for trivial/doc-only work
...
- [ ] Adversarial review (Opus + Codex + Gemini) on auth changes
      - Directory: subagents/20260105-1530-adversarial-*/
```
